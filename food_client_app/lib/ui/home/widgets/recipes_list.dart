...
class RecipesList extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) => PageStorage(
        bucket: pageStorageBucket,
        child: PagedListView<int, HomeModelRecipe>(
          padding: EdgeInsets.zero,
          key: const PageStorageKey<String>('recipes'),
          pagingController: ref.watch(homeModelPagingControllerProvider),
          builderDelegate: PagedChildBuilderDelegate<HomeModelRecipe>(
            itemBuilder: (
              ...
              recipe: recipe,
              onTap: () =>
                  ref.read(homeControllerProvider).goToSingleRecipeView(
                        recipeId: recipe.id,
            ...
            firstPageErrorIndicatorBuilder: (final _) => Column(
              children: <Widget>[
                ...
                ElevatedButton.icon(
                  onPressed:
                      ref.read(homeControllerProvider).retryLastRecipeFetching,
